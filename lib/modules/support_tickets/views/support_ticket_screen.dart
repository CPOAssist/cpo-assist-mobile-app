...
class _SupportTicketScreenState extends State<SupportTicketScreen> {
            ...
            child: Row(
              children: [
                Expanded(
                  child: TextField(
                    onChanged: (value) {
                      supportTicketController!.assignedSearchOperation();
                    },
                    controller:
                        supportTicketController!.assignedSearchTextController,
  ...
  Widget assignedListItem(BuildContext context, int index) {
    return Container(
      ...
      child: InkWell(
        onTap: () {
          Get.toNamed(AppRoutes.supportTicketFormOne);
        },
        child: Column(
          children: [
            Row(
            ...
            child: Row(
              children: [
                Expanded(
                  child: TextField(
                    onChanged: (value) {
                      supportTicketController!.savedSearchOperation();
                    },
                    controller:
                        supportTicketController!.savedSearchTextController,
                    keyboardType: TextInputType.text,
                    decoration: InputDecoration(
                      isDense: true,
                      contentPadding: EdgeInsets.zero,
            ...
            child: Row(
              children: [
                Expanded(
                  child: TextField(
                    onChanged: (value) {
                      supportTicketController!.historySearchOperation();
                    },
                    controller:
                        supportTicketController!.historySearchTextController,
                    keyboardType: TextInputType.text,
                    decoration: InputDecoration(
                      isDense: true,
                      contentPadding: EdgeInsets.zero,
