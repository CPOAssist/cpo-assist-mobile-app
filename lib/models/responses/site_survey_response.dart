class SiteSurveyObjectResponse {
  String? message;
  Data? data;
  String? httpStatus;
  int? httpStatusCode;

  SiteSurveyObjectResponse(
      {this.message, this.data, this.httpStatus, this.httpStatusCode});

  SiteSurveyObjectResponse.fromJson(Map<String, dynamic> json) {
...
class Data {
  int? total;
  List<SiteSurveyObjectRequests>? requests;

  Data({this.total, this.requests});

  Data.fromJson(Map<String, dynamic> json) {
    total = json['TOTAL'];
    if (json['REQUESTS'] != null) {
      requests = <SiteSurveyObjectRequests>[];
      json['REQUESTS'].forEach((v) {
        requests!.add(SiteSurveyObjectRequests.fromJson(v));
      });
    }
  }
...
class SiteSurveyObjectRequests {
  String? createdAt;
  int? id;
  String? status;
  String? onSiteName;
  ...
  SiteSurveyObjectRequests.fromJson(Map<String, dynamic> json) {
    ...
    secondaryNumber = json['secondryNumber'];
    ...
    if (json['footFall'] != null) {
      footFall = <FootFall>[];
      json['footFall'].forEach((v) {
        footFall!.add(FootFall.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['secondryNumber'] = secondaryNumber;
...
class FootFall {
  ...
  FootFall({this.id, this.footFall});

  FootFall.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Document {
  ...
  Document({this.id, this.fileUrl, this.title});
